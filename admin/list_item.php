...
//        $oplata = return_all_translate_for_reference_value($info_order['oplata'], $id_online_lang);
        ...
        if ($info_order['dostavka']==2){
            ...
            <div class="span3"><select id="warehouse_'.$info_order['id'].'" class="form-control"><option value="0">Сделайте выбор</option>'.getWarehouse($infoCity['id'], $infoWarehouse['id']).'</select></div>
        </div>';
        } else {
            $onlyNP = '
            <div class="row">
